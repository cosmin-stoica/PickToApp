package com.example.picktolightapp.Model_DB.User;
...
public enum TipoUser {
    ...
    public static com.example.picktolightapp.Model_DB.User.TipoUser fromCodice(int codice) {
        for (com.example.picktolightapp.Model_DB.User.TipoUser tipo : com.example.picktolightapp.Model_DB.User.TipoUser.values()) {
